...
ALLOWED_TASKS = {
    "OKX_WITHDRAW", "RANDOM_TXS", "RUBYSCORE_VOTE", "WRAPPER_UNWRAPPER", "CONTRACT_DEPLOY", "RANDOM_SWAPS", "SWAP_ALL_TO_ETH",
    "UNISWAP", "MATCHA_SWAP", "SUSHI_SWAP", "BUNGEE_SWAP", "OWLTO_SWAP", "RELAY_SWAP", "OKU_SWAP", "DEFILLAMA_SWAP"
}
